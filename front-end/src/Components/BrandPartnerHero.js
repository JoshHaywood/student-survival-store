      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                Sales that your brand
                <br className="hidden md:block" />
                will simply{' '}
                <span className="inline-block text-green-accent-400">
                 love
                </span>
              </h2>
          ...
          <div className="relative">
            <svg
              className="absolute w-full text-primary fill-primary fill-current text-green-600"
              viewBox="0 0 600 392"
            >
            ...
            <svg
              className="relative w-full text-primary fill-grey-400"
              viewBox="0 0 600 392"
            >

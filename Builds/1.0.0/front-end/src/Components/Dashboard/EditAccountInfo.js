...
const EditAccountInfo = () => {
  ...
  return (
    <section className="bg-gray-900 bg-hero-pattern bg-cover w-screen">
      <div className="px-0 py-20 mx-auto  sm:px-4 w-full">
        <div className="w-full px-4 pt-5 pb-6 mx-auto mt-8 mb-6 bg-white rounded-none shadow-xl sm:rounded-lg sm:w-8/12 md:w-8/12 lg:w-10/12 xl:w-6/12 sm:px-6">
